...
export function normalizeProduct(raw: any): Product {
  ...
  return {
    ...
    compareAtPrice,
    discountPercent,
    rating: Number(raw.rating ?? raw.average_rating ?? raw.avg_rating ?? raw.averageRating ?? 0),
    reviewCount: Number(raw.reviewCount ?? raw.reviews_count ?? raw.review_count ?? raw.totalReviews ?? 0),
    images: uniqueImages,
